...
struct TypePolishWorkspaceView: View {
        ...
        VStack(alignment: .leading, spacing: 18) {
            HStack(spacing: 10) {
                ...
                VStack(alignment: .leading, spacing: 2) {
                    ...
                    Text("Use these actions from QuickGlass on selected prose.")
                        .font(.callout)
            ...
            VStack(alignment: .leading, spacing: 10) {
                ForEach(TypePolishActionCatalog.all, id: \.rawValue) { action in
            ...
            Text("The Store requires a workspace, but Type Polish is built for QuickGlass.")
                .font(.caption)
                .foregroundStyle(Color(nsColor: theme.theme.secondaryTextColor))
        }
        .padding(24)
